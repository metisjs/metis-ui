...
export class FormStore {
  ...
  private warning = devUseWarning('Form');
  ...
  public getForm = (): InternalFormInstance => ({
    ...
    _getInternalHooks: this._getInternalHooks,
  });

  // ======================== Internal Hooks ========================
  private _getInternalHooks = (): InternalHooks => {
  ...
  private getFieldsValue = (
    ...
    const fieldEntities = this.getFieldEntitiesForNamePathList(
      Array.isArray(mergedNameList) ? mergedNameList : undefined,
    );
  ...
  private isFieldsTouched: InternalIsFieldsTouched = (...args: any[]) => {
    this.warningUnhooked();
