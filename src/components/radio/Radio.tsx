...
const InternalRadio: React.ForwardRefRenderFunction<RadioRef, RadioProps> = (props, ref) => {
  ...
  const indicatorCls = clsx(
    'border-border bg-container block size-4 cursor-pointer rounded-full border text-white',
    'peer-focus-visible/radio:outline-primary peer-focus-visible/radio:outline-2 peer-focus-visible/radio:outline-offset-2',
    {
