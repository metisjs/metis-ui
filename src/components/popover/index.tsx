...
const Popover = React.forwardRef<TooltipRef, PopoverProps>((props, ref) => {
  ...
  const popupInnerCls = clsx(
    'ring-neutral-border-secondary teborder-lg z-[1030] cursor-auto select-text rounded-lg p-3 ring-1 focus:outline-none',
  );

  const arrowCls = clsx('after:ring-neutral-bordeborderter:ring-1');
