...
export interface ColumnType<RecordType extends AnyObject> extends ColumnSharedType<RecordType> {
  ...
  valueType?:
    | ColumnValueType
    | ColumnValueObject
    | ((record: RecordType) => ColumnValueObject | ColumnValueObject);
  valueEnum?:
    | ((record: RecordType) => ColumnValueEnumObj | ColumnValueEnumMap)
    | ColumnValueEnumObj
    | ColumnValueEnumMap;
}
...
export type ColumnValueTypeWithFieldProps = {
  /** 文本输入框 */
  text: InputProps;
  /** 密码输入框 */
...
export type ColumnValueType = Extract<keyof ColumnValueTypeWithFieldProps, any>;
...
export type ColumnValueEnumType = {
  label: React.ReactNode;
  status?: string;
  color?: string;
  disabled?: boolean;
...
export type ColumnValueEnumMap = Map<
  string | number | boolean,
  ColumnValueEnumType | React.ReactNode
>;

export type ColumnValueEnumObj = Record<string, ColumnValueEnumType | React.ReactNode>;
