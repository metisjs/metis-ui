  ...
  return (
    <button
      ...
      className={clsx(
        ...
        'outline-border focus-visible:outline-primary relative inline-flex h-4 w-4 rounded-sm align-sub outline-1 -outline-offset-1 transition-all duration-300 select-none focus-visible:outline-2 focus-visible:-outline-offset-1',
