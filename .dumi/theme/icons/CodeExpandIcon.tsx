...
const CodeExpandIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 200 117" width="1em" height="1em" className={className} fill="currentColor">
