    ...
    <main>
      <div className="pointer-events-none sticky top-[76px] z-50 -mb-12 overflow-hidden pb-12">
        <div className="relative">
          <div className="dark:bg-[#0a0e13] pointer-events-auto relative bg-white pb-4 shadow-[0_1px_3px_rgba(15,23,42,0.08)]">
