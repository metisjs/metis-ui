...
export default () => (
  ...
  />
);`},"metis-ui":{type:"NPM",value:"1.0.4"}},entry:"index.tsx"},context:{"metis-ui":f},renderOpts:{compile:function(){var u=I()(t()().mark(function d(){var r,i=arguments;return t()().wrap(function(n){for(;;)switch(n.prev=n.next){case 0:return n.next=2,e.e(1317).then(e.bind(e,61317));case 2:return n.abrupt("return",(r=n.sent).default.apply(r,i));case 3:case"end":return n.stop()}},d)}));function l(){return u.apply(this,arguments)}return l}()}}}},83982:function(m,a,e){e.r(a),e.d(a,{demos:function(){return w}});var o=e(90228),t=e.n(o),P=e(87999),I=e.n(P),s=e(39546),b=e(11801),f=e(92475),w={"docs-style-override-demo-en-us-0":{component:s.memo(s.lazy(I()(t()().mark(function u(){var l,d,r,i,p,n,C;return t()().wrap(function(c){for(;;)switch(c.prev=c.next){case 0:return c.next=2,Promise.resolve().then(e.bind(e,11801));case 2:return l=c.sent,d=l.MagnifyingGlassOutline,c.next=6,Promise.resolve().then(e.bind(e,92475));case 6:return r=c.sent,i=r.Button,p=r.ConfigProvider,n=r.Input,C=r.Space,c.abrupt("return",{default:function(){return s.createElement(p,{button:{className:{root:"outline-primary rounded-xl",icon:"size-5"}},input:{className:{root:"outline-primary rounded-xl",prefix:"text-error",suffix:"text-error"}}},s.createElement(C,{vertical:!0},s.createElement(n,{prefix:"\uFFE5",suffix:"RMB"}),s.createElement(i,{icon:s.createElement(d,null)},"Submit")))}});case 12:case"end":return c.stop()}},u)})))),asset:{type:"BLOCK",id:"docs-style-override-demo-en-us-0",refAtomIds:[],dependencies:{"index.tsx":{type:"FILE",value:`import { MagnifyingGlassOutline } from '@metisjs/icons';
